...
public class SettingsController1 extends BaseController implements StbService.StateListener {
    ...
    protected void onViewBound(@NonNull View view) {
        ...
        application.setStateListener(SettingsController1.this);
    }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_PROG_RED) {
            ...
            if (focusedChild != null) {
                ...
                String address = sharedPref.getString("server_address_" + position, "");
                if (!address.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Please Add Server Address first.", Toast.LENGTH_LONG).show();
                } else {
                ...
                .setPositiveButton("Connect", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!TextUtils.isEmpty(serverAddress)) {
                            ...
                            Toast.makeText(getApplicationContext(), "Server Address can't be left empty", Toast.LENGTH_LONG).show();
